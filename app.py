...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Văn Tuyên - Trường PTDTBT Tiểu học Ngam La - ĐT: 098 3923 809</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 -  Nguyễn Văn Tuyên - Trường PTDTBT Tiểu học Ngam La - ĐT: 098 3923 809</div>", unsafe_allow_html=True)
